/**
 * Type definitions for the Polymarket auto-trading system
 */
...
export interface MarketWindow {
  ...
  endTime: number;
  /** Unix timestamp when trading window starts (T-Ns) */
...
/**
 * Trading job payload for BullMQ
 */
...
/**
 * Trading credentials configuration
 */
