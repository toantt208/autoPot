...
export const EVENTS: Record<string, EventConfig> = {
  // 15-minute markets (trading window: last 2 minutes)
  ...
  xrp_15m: { crypto: 'xrp', interval: 15, tradingWindowSeconds: 88, slugName: 'xrp', slugFormat: '15m' },
  // 1-hour markets (trading window: last 2 minutes)
